      ...
      <div className={styles.sectionHeader}>
        <div className={styles.sectionHeaderMain}>
          ...
          <p className={styles.sectionDescription}>
            The dashboard validates the generated config before activation. Activation writes the resulting YAML to{' '}
            <code>config.yaml</code> and exits setup mode.
          </p>
        ...
        <div className={styles.reviewCard}>
          ...
          <div className={styles.reviewStats}>
            <div className={styles.reviewStat}>
              ...
              <span className={styles.reviewStatValue}>{listenerPort ? `:${listenerPort}` : 'Bootstrap'}</span>
            </div>
            <div className={styles.reviewStat}>
              <span className={styles.reviewStatLabel}>Models</span>
              <span className={styles.reviewStatValue}>{validatedCounts.models || modelsCount}</span>
            </div>
            <div className={styles.reviewStat}>
              <span className={styles.reviewStatLabel}>Decisions</span>
              <span className={styles.reviewStatValue}>{validatedCounts.decisions || generatedDecisions}</span>
            </div>
          </div>
