...
└── data/
    ├── benchmark_training_data.jsonl    # Benchmark data for training
    └── trained_models/                  # Generated by Python training
        ├── knn_model.json
        ├── kmeans_model.json
        └── svm_model.json

src/training/ml_model_selection/         # Python training scripts
...
# Train from benchmark data
python train.py \
  --data-file ../../semantic-router/pkg/modelselection/data/benchmark_training_data.jsonl \
  --output-dir ../../semantic-router/pkg/modelselection/data/trained_models \
...
python upload_model.py \
  --model-dir ../../semantic-router/pkg/modelselection/data/trained_models \
  --repo-id abdallah1008/semantic-router-ml-models
```
